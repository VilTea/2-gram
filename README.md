...
```
**未登录词识别结果：** 
`{'轩逸': 68, '陌陌': 24, '蛋挞': 20, '渣渣': 14, '汪峰': 13, '蹭蹭': 13, '棵树': 14, '呷哺': 57, '吐槽': 152, '逆袭': 41, '骊威': 24, '丧尸': 7, '郝蕾': 4, '睇睇': 17, '悲催': 102, '仁孚': 11, '闺蜜': 19, '杨幂': 117, '坑爹': 245}`

## 运行截图
* 运行环境
  * PyCharm Community Edition 2020.1 x64
  
![](https://raw.githubusercontent.com/VilTea/2-gram/master/Image/Image20200525152959.png)
## 更新日志
2020/5/21 - `完成了基本的分词功能。`<br>
2020/5/25 - `对原有代码进行了小幅度的性能优化`; `完成了基本的未登录词识别功能。（会尝试在后续的更新中继续对其性能优化）`
